...
def train_lora_adapter(
    ...
    margin=0.3,
    save_path="weights/lora_adapter.pth"
):
...
def main():
    ...
    train_lora_adapter(
        ...
        margin=args.margin,
        save_path=f"weights/lora_adapter_{args.dataset}_k{args.k_shot}_r{args.lora_rank}_b{args.adapter_bottleneck}.pth"
    )
