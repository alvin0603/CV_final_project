...
from src.prompt_tuning import load_prompt_tuner
from sklearn.metrics import average_precision_score, roc_auc_score


def evaluate_prompt_image_level(
    dataset_name,
    prompt_tuner_path,
    output_dir
):
    ...
    for category in categories:
        print(f"\n=== Prompt-Tuned Image-Level Eval: {category} ===")
    ...
    csv_path = os.path.join(output_dir, "image_level_metrics_prompt.csv")
...
def main():
    ...
    parser.add_argument("--output_dir", default="outputs/image_level/prompt")
    args = parser.parse_args()
    
    evaluate_prompt_image_level(
