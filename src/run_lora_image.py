...
def evaluate_lora_image_level(
    ...
    for category in categories:
        print(f"\n=== LoRA Image-Level Eval: {category} ===")
    ...
    csv_path = os.path.join(output_dir, "image_level_metrics_lora.csv")
...
def main():
    ...
    parser.add_argument("--output_dir", default="outputs/image_level/lora")
    parser.add_argument("--rank", type=int, default=4)
    parser.add_argument("--alpha", type=float, default=1.0)
    args = parser.parse_args()
    
    evaluate_lora_image_level(
